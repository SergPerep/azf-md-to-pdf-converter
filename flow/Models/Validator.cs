...
namespace Models
{
    ...
    {
        public static void ValidateMdImagePaths(List<Md> mds, List<string> imgFilePaths)
        {
            ...
            foreach (var md in mds)
            {
                ...
                foreach (var imgSyntax in imgSyntaxes.Where(i => i != null))
                {
                    ...
                    Console.WriteLine("|- img (relative path): " + imgAbsolutePath);
                }
            }
